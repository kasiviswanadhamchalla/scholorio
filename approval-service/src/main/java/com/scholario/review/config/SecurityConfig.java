package com.scholario.review.config;

import com.scholario.review.security.JwtAuthenticationFilter;
import com.scholario.review.security.KeycloakJwtAuthenticationConverter;
import com.scholario.review.security.UnassignedRoleFilter;
...
public class SecurityConfig {
    ...
    public JwtDecoder jwtDecoder() {
        if (!keycloakEnabled) {
            log.info("Keycloak authentication is explicitly disabled in Approval Service.");
            return null;
        }
