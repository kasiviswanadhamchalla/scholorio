package com.scholario.violation.config;

import com.scholario.violation.security.JwtAuthenticationFilter;
import com.scholario.violation.security.KeycloakJwtAuthenticationConverter;
import com.scholario.violation.security.UnassignedRoleFilter;
...
public class SecurityConfig {
    ...
    public JwtDecoder jwtDecoder() {
        if (!keycloakEnabled) {
            log.info("Keycloak authentication is explicitly disabled in Audit Service.");
            return null;
        }
