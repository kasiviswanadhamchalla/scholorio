package com.scholario.recommendation.config;

import com.scholario.recommendation.security.JwtAuthenticationFilter;
import com.scholario.recommendation.security.KeycloakJwtAuthenticationConverter;
import com.scholario.recommendation.security.UnassignedRoleFilter;
...
public class SecurityConfig {
    ...
    public JwtDecoder jwtDecoder() {
        if (!keycloakEnabled) {
            log.info("Keycloak authentication is explicitly disabled in Search Service.");
            return null;
        }
