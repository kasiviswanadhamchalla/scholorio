package com.scholario.notification.config;

import com.scholario.notification.security.JwtAuthenticationFilter;
import com.scholario.notification.security.KeycloakJwtAuthenticationConverter;
import com.scholario.notification.security.UnassignedRoleFilter;
...
public class SecurityConfig {
    ...
    public JwtDecoder jwtDecoder() {
        if (!keycloakEnabled) {
            log.info("Keycloak authentication is explicitly disabled in Notification Service.");
            return null;
        }
