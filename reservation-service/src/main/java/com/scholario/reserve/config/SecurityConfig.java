package com.scholario.reserve.config;

import com.scholario.reserve.security.JwtAuthenticationFilter;
import com.scholario.reserve.security.KeycloakJwtAuthenticationConverter;
import com.scholario.reserve.security.UnassignedRoleFilter;
...
public class SecurityConfig {
    ...
    public JwtDecoder jwtDecoder() {
        if (!keycloakEnabled) {
            log.info("Keycloak authentication is explicitly disabled in Reservation Service.");
            return null;
        }
