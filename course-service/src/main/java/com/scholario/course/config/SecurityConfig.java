package com.scholario.course.config;

import com.scholario.course.security.JwtAuthenticationFilter;
import com.scholario.course.security.KeycloakJwtAuthenticationConverter;
import com.scholario.course.security.UnassignedRoleFilter;
...
public class SecurityConfig {
    ...
    public JwtDecoder jwtDecoder() {
        if (!keycloakEnabled) {
            log.info("Keycloak authentication is explicitly disabled in Course Service.");
            return null;
        }
