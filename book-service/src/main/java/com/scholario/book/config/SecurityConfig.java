...
import com.scholario.book.security.JwtAuthenticationFilter;
import com.scholario.book.security.KeycloakJwtAuthenticationConverter;
import com.scholario.book.security.UnassignedRoleFilter;
...
public class SecurityConfig {
    ...
    public JwtDecoder jwtDecoder() {
        if (!keycloakEnabled) {
            log.info("Keycloak authentication is explicitly disabled in Book Service.");
            return null;
        }
    ...
    public BearerTokenResolver bearerTokenResolver() {
        ...
        return request -> {
            if (SecurityContextHolder.getContext().getAuthentication() != null) {
                // If local JWT was already validated and authentication is set, skip bearer resolution
                return null;
            }
