package com.scholario.content.config;

import com.scholario.content.security.JwtAuthenticationFilter;
import com.scholario.content.security.KeycloakJwtAuthenticationConverter;
import com.scholario.content.security.UnassignedRoleFilter;
...
public class SecurityConfig {
    ...
    public JwtDecoder jwtDecoder() {
        if (!keycloakEnabled) {
            log.info("Keycloak authentication is explicitly disabled in Content Service.");
            return null;
        }
