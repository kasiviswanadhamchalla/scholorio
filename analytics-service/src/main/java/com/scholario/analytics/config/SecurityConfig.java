package com.scholario.analytics.config;

import com.scholario.analytics.security.JwtAuthenticationFilter;
import com.scholario.analytics.security.KeycloakJwtAuthenticationConverter;
import com.scholario.analytics.security.UnassignedRoleFilter;
...
public class SecurityConfig {
    ...
    public JwtDecoder jwtDecoder() {
        if (!keycloakEnabled) {
            log.info("Keycloak authentication is explicitly disabled in Analytics Service.");
            return null;
        }
